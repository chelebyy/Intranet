...
namespace IntranetPortal.Infrastructure.Migrations
{
    ...
    [Migration("20251216200753_AddAnnouncementSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntranetPortal.Domain.Entities.Announcement", b =>
                {
            ...
            modelBuilder.Entity("IntranetPortal.Domain.Entities.AnnouncementTarget", b =>
                {
            ...
            modelBuilder.Entity("IntranetPortal.Domain.Entities.IPRestriction", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("IntranetPortal.Domain.Entities.Unvan", b =>
                {
            ...
            modelBuilder.Entity("IntranetPortal.Domain.Entities.UserAcknowledgment", b =>
                {
                    b.Property<int>("AcknowledgmentID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("AcknowledgmentID"));
            ...
            modelBuilder.Entity("IntranetPortal.Domain.Entities.Announcement", b =>
                {
                    b.HasOne("IntranetPortal.Domain.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("IntranetPortal.Domain.Entities.AnnouncementTarget", b =>
                {
                    b.HasOne("IntranetPortal.Domain.Entities.Announcement", "Announcement")
                        .WithMany("Targets")
            ...
            modelBuilder.Entity("IntranetPortal.Domain.Entities.User", b =>
                {
                    b.HasOne("IntranetPortal.Domain.Entities.Unvan", null)
                        .WithMany("Users")
